...
function ScrollButton() {
  ...
  return (
    <>
      <a
        className={`text-3xl mb-24 fixed bottom-4 right-4  mx-auto bg-opacity-80  w-114 h-14 transition-opacity duration-300 hover:scale-110 p-2 ${
      ...
      <button
        className={`text-3xl fixed bottom-4 right-4 border-2 border-red-300 mr-2 bg-gray-dark mx-auto bg-opacity-80 rounded-full w-114 h-14 transition-opacity duration-300 hover:scale-110 p-2 ${
          scroll ? "opacity-100" : "opacity-0"
        }`}
        onClick={scrollToTop}
      >
